...
- [ ] **1.1 — Wow moment: paste aspirin, see it rendered in 2D + 3D with formula/weight**
...
- [ ] **1.2 — Generate real 3D conformers with RDKit.js**
  - `@rdkit/rdkit` (WASM) parses the SMILES and produces an embedded 3D
    conformer (ETKDG) as a mol block, replacing the empty placeholder viewer.
...
- [ ] **1.3 — Formula and molecular weight from RDKit, not a placeholder**
...
- [ ] **1.4 — Handle a broad, realistic range of SMILES input**
...
- [ ] **2.2 — Design polish pass against docs/DESIGN.md**
...
- [ ] **2.4 — Quick-pick example gallery**
...
- [ ] **3.1 — Cold-start loading state for the RDKit WASM module**
...
- [ ] **3.2 — Guard against pathological input**
...
- [ ] **3.3 — Copy-to-clipboard for formula and SMILES**
